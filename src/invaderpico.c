...
uint32_t keystatus,keystatus2,oldkey; //最新のボタン状態と前回のボタン状態
int ufox; //UFO X座標
...
static int stage; //ステージ番号
static int gamestatus; //ゲームステータス
...
static unsigned int highscore,score; //ハイスコア、得点
